...
def main() -> None:
    ...
    ap.add_argument(
        "--out-dir",
        type=Path,
        default=root / "figures" / "manuscript_netmhc" / "fig5_sig_vs_proportional_whole",
    ...
    py = sys.executable
    merge_py = root / "scripts" / "merge_netmhcpan_xls_with_iedb.py"
    figabc = root / "scripts" / "plot_fig5abc_netmhc_sb_triple.py"
    figde = root / "scripts" / "plot_fig5de_merged_iedb_sb_per_allele.py"
    ...
    readme.write_text(
        ...
        f"Generated by: python scripts/run_fig5_sig_vs_proportional_coding.py\n",
        encoding="utf-8",
    )
